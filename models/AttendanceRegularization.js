...
const REGULARIZATION_TYPES = ["missing_clock_in", "missing_clock_out", "attendance_correction", "late_entry"];
...
const attendanceRegularizationSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, enum: REGULARIZATION_STATUSES, default: "pending", index: true },
    branchAdminDecisionBy: { type: mongoose.Schema.Types.ObjectId, ref: "User", default: null },
    branchAdminDecisionAt: { type: Date },
    superAdminDecisionBy: { type: mongoose.Schema.Types.ObjectId, ref: "User", default: null },
